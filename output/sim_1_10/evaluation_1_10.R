...
db1_10 = dbConnect(SQLite(), dbname = "db1_10")
...
ate = dbGetQuery(db1_10, "SELECT * FROM average_te")
te_ens = as.matrix(dbGetQuery(db1_10, "SELECT * FROM treatmenteffect_ens"))
te_lasso = as.matrix(dbGetQuery(db1_10, "SELECT * FROM treatmenteffect_lasso"))
te_xgb = as.matrix(dbGetQuery(db1_10, "SELECT * FROM treatmenteffect_xgb"))
te_nn = as.matrix(dbGetQuery(db1_10, "SELECT * FROM treatmenteffect_nn"))
true_te = as.matrix(dbGetQuery(db1_10, "SELECT * FROM te_true"))
true_p = as.matrix(dbGetQuery(db1_10, "SELECT * FROM p_true"))
# standard errors
se_te = dbGetQuery(db1_10, "SELECT * FROM standerror_te")
se_po = dbGetQuery(db1_10, "SELECT * FROM standerror_po")
#ensemble weights
ps_ensemble = dbGetQuery(db1_10, "SELECT * FROM propensity_ensemble")
oc_ensemble = dbGetQuery(db1_10, "SELECT * FROM outcome_ensemble")
# Confidence Intervals
CI_up_ens = dbGetQuery(db1_10, "SELECT * FROM CI_up_ens")
CI_down_ens = dbGetQuery(db1_10, "SELECT * FROM CI_down_ens")
CI_up_lasso = dbGetQuery(db1_10, "SELECT * FROM CI_up_lasso")
CI_down_lasso = dbGetQuery(db1_10, "SELECT * FROM CI_down_lasso")
CI_up_xgb = dbGetQuery(db1_10, "SELECT * FROM CI_up_xgb")
CI_down_xgb = dbGetQuery(db1_10, "SELECT * FROM CI_down_xgb")
CI_up_nn = dbGetQuery(db1_10, "SELECT * FROM CI_up_nn")
CI_down_nn = dbGetQuery(db1_10, "SELECT * FROM CI_down_nn")
...
pdf_file = file.path(figure_path, paste0("plot_overlap_1_10", ".pdf"))
...
# save plots as pdf
pdf_file = file.path(figure_path, paste0("ps_plot_1_10", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("oc_plot_1_10", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("rmse_ate_1_10", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("bias_ate_1_10", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("violin_ate_1_10", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("plot_all_errors_1_10", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("rmse_ate_eachsim_1_10", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("MSE_ate_eachsim_1_10", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("ps_development_1_10", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("oc_development_1_10", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("corr_plot_1_10", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("corr_map_1_10", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("coverage_probs_1_10", ".pdf"))
...
jb_ens = jb.norm.test(ate$ens, nrepl = 500)
jb_lasso = jb.norm.test(ate$lasso, nrepl = 500)
jb_xgb = jb.norm.test(ate$xgb, nrepl = 500)
jb_nn = jb.norm.test(ate$nn, nrepl = 500)

jb_values_all = cbind.data.frame(ml_names, rbind.data.frame(jb_ens, jb_lasso, jb_xgb, jb_nn))

# illustration of true_te to X
plot_data_te_x = cbind.data.frame(data.table(true_te[1,]), x_example$V3)
colnames(plot_data_te_x) = c("TE", "X3")
plot_data_te_x = plot_data_te_x[order(plot_data_te_x$X3),]

plot_te_x = ggplot(plot_data_te_x, aes(x = X3, y = TE))+
  geom_line() +
  stat_smooth()
