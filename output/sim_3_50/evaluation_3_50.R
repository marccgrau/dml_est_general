...
db3_50 = dbConnect(SQLite(), dbname = "db3_50")
...
ate = dbGetQuery(db3_50, "SELECT * FROM average_te")
te_ens = as.matrix(dbGetQuery(db3_50, "SELECT * FROM treatmenteffect_ens"))
te_lasso = as.matrix(dbGetQuery(db3_50, "SELECT * FROM treatmenteffect_lasso"))
te_xgb = as.matrix(dbGetQuery(db3_50, "SELECT * FROM treatmenteffect_xgb"))
te_nn = as.matrix(dbGetQuery(db3_50, "SELECT * FROM treatmenteffect_nn"))
true_te = as.matrix(dbGetQuery(db3_50, "SELECT * FROM te_true"))
true_p = as.matrix(dbGetQuery(db3_50, "SELECT * FROM p_true"))
# standard errors
se_te = dbGetQuery(db3_50, "SELECT * FROM standerror_te")
se_po = dbGetQuery(db3_50, "SELECT * FROM standerror_po")
#ensemble weights
ps_ensemble = dbGetQuery(db3_50, "SELECT * FROM propensity_ensemble")
oc_ensemble = dbGetQuery(db3_50, "SELECT * FROM outcome_ensemble")
# Confidence Intervals
CI_up_ens = dbGetQuery(db3_50, "SELECT * FROM CI_up_ens")
CI_down_ens = dbGetQuery(db3_50, "SELECT * FROM CI_down_ens")
CI_up_lasso = dbGetQuery(db3_50, "SELECT * FROM CI_up_lasso")
CI_down_lasso = dbGetQuery(db3_50, "SELECT * FROM CI_down_lasso")
CI_up_xgb = dbGetQuery(db3_50, "SELECT * FROM CI_up_xgb")
CI_down_xgb = dbGetQuery(db3_50, "SELECT * FROM CI_down_xgb")
CI_up_nn = dbGetQuery(db3_50, "SELECT * FROM CI_up_nn")
CI_down_nn = dbGetQuery(db3_50, "SELECT * FROM CI_down_nn")
...
pdf_file = file.path(figure_path, paste0("plot_overlap_3_50", ".pdf"))
...
# save plots as pdf
pdf_file = file.path(figure_path, paste0("ps_plot_3_50", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("oc_plot_3_50", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("rmse_ate_3_50", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("bias_ate_3_50", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("violin_ate_3_50", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("plot_all_errors_ate_3_50", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("rmse_ate_eachsim_3_50", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("MSE_ate_eachsim_3_50", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("ps_development_3_50", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("oc_development_3_50", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("corr_plot_3_50", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("corr_map_3_50", ".pdf"))
...
pdf_file = file.path(figure_path, paste0("coverage_probs_3_50", ".pdf"))
